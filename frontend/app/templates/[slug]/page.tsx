...
export default function TemplateDetails() {
  ...
  // 1. Safely find static fallback (Changed to Templates since this is TemplateDetails)
  const staticProduct = Templates?.find((item) => item.slug === slug) || null
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center p-8 text-center">
        ...
        <p className="mt-2 text-muted-foreground max-w-md">
          The requested template could not be found. It may have been removed or the link is incorrect.
        </p>
      </div>
    )
  }
