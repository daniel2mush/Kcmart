...
export default function MagazineDetails() {
  ...
  // 1. Safely find static fallback (Changed to Magazines since this is MagazineDetails)
  const staticProduct = Magazines?.find((item) => item.slug === slug) || null
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center p-8 text-center">
        ...
        <p className="mt-2 text-muted-foreground max-w-md">
          The requested Magazine could not be found. It may have been removed or the link is incorrect.
        </p>
      </div>
    )
  }
