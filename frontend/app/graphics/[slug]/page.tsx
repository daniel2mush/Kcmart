...
export default function GraphicDetails() {
  ...
  // 1. Safely find static fallback (Changed to Graphics since this is GraphicDetails)
  const staticProduct = Graphics?.find((item) => item.slug === slug) || null
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center p-8 text-center">
        ...
        <p className="mt-2 text-muted-foreground max-w-md">
          The requested Graphic could not be found. It may have been removed or the link is incorrect.
        </p>
      </div>
    )
  }
